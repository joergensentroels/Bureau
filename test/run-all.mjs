...
const PURE = ["decision.test.mjs", "units.test.mjs", "scope.test.mjs", "reasoning-cap.test.mjs", "finding-gate.test.mjs", "net.test.mjs", "heartbeat.test.mjs", "readme-demo.test.mjs", "ui.test.mjs"];
