...
const PURE = ["secret-scan.test.mjs", "ps1-encoding.test.mjs", "secret-tokens.test.mjs", "compose-boundary.test.mjs", "state-dir.test.mjs", "harness.test.mjs", "decision.test.mjs", "units.test.mjs", "scope.test.mjs", "reasoning-cap.test.mjs", "probe-doctor.test.mjs", "finding-gate.test.mjs", "net.test.mjs", "heartbeat.test.mjs", "readme-demo.test.mjs", "docs.test.mjs", "searchable-source.test.mjs", "ui.test.mjs", "action-surface.test.mjs", "hunt-scope.test.mjs", "hunt-dispatch.test.mjs", "gate-harness.test.mjs"];
