...
Current totals: **<!--fig:pure-assertions-->1,873 pure assertions** across
**<!--fig:pure-suites-->23 pure suites**, plus **<!--fig:server-assertions-->324 server assertions**
across **<!--fig:server-suites-->6 server suites** — **<!--fig:assertions-->2,197 headless assertions
