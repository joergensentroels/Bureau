...
Current totals: **<!--fig:pure-assertions-->1,732 pure assertions** across
**<!--fig:pure-suites-->21 pure suites**, plus **<!--fig:server-assertions-->311 server assertions**
across **<!--fig:server-suites-->6 server suites** — **<!--fig:assertions-->2,043 headless assertions
across <!--fig:suites-->27 suites** in all. The live `--e2e` adds 18 more and is not counted here,
